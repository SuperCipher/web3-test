...
def prepare_contract_4kb(w3, funding_account):
    greeter = w3.eth.contract(
        address='0xFe0c591eAF5B0feAE1E72dc39706Ca17eEc6BAd9',
...
def prepare_contract_56kb(w3, funding_account):
    greeter = w3.eth.contract(
        address='0xF8115FbBd02141f5848Ab25cA93Bc5119EE0B166',
...
def main(iteration: int = typer.Argument(1)):
    ...
    with open('exe_time.csv', 'w', newline='') as csvfile:
        ...
        while(i <= iteration):
            ...
            greeter = prepare_contract_4kb(w3,acct)
            ...
            greeter2 = prepare_contract_56kb(w3,acct)
