...
BID_RETRIEVAL_BATCH_SIZE: constant(uint256) = 32
...
interface layer2interface:
        def layer2call(arg1: int128) -> int128: view
@external
def layer1call(arg1: address, arg2: int128) -> int128:
    return layer2interface(arg1).layer2call(arg2)
